...
import { RootState, notesActions, reservationActions, modalActions } from "store/";

import { EditeNoteModal } from "components/UI";
...
export const Note: React.FC<{ note: NoteClass }> = ({ note }) => {
